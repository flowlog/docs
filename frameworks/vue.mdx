...
function handleClick() {
  flowlogjs.track("click_button_count");
  count.value++;
}
...
##### Use a consistent naming convention for your events to make it easier to analyze and compare data across different events. For example, if you have a button click event, you could name it `click_button`, `purchase_product`, `update_plan`.
